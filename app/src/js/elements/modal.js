...
export const Modal = props => {
  ...
  return (
    <Container>
      <Inner position={props.position} width={props.width} height={props.height} frameless={frameless}>
        {!frameless && header && (
          <Title>
            <TitleText>{props.title}</TitleText>
            {props.toolbar && <React.Fragment>{props.toolbar}</React.Fragment>}
            <Button>
              <svg
        ...
        {props.footer && (
          <Footer>
            <FooterPadding>{props.footer}</FooterPadding>
          </Footer>
        )}
      </Inner>
    </Container>
