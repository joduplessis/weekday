...
CREATE TABLE hdb_catalog.hdb_version (
    hasura_uuid uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.poll_votes (
    id integer DEFAULT nextval('public.poll_votes_id_seq'::regclass) NOT NULL,
...
CREATE TABLE public.polls (
    id integer DEFAULT nextval('public.polls_id_seq'::regclass) NOT NULL,
...
public	poll_votes	poll	object	{"foreign_key_constraint_on": "poll_id"}	\N	f
public	polls	poll_votes	array	{"foreign_key_constraint_on": {"table": "poll_votes", "column": "poll_id"}}	\N	f
\.
...
b73cb96e-b552-44ea-bb91-ee329f96d27a	2022-02-26 07:31:38.771689+00
\.
...
public	poll_votes	{"custom_root_fields": {"delete": null, "insert": null, "select": null, "update": null, "select_by_pk": null, "select_aggregate": null}, "custom_column_names": {}}	f	f
public	polls	{"custom_root_fields": {"delete": null, "insert": null, "select": null, "update": null, "select_by_pk": null, "select_aggregate": null}, "custom_column_names": {}}	f	f
\.
...
bfe922c3-cc2a-4c6c-ba8f-dd2b19fc4b44	26	2022-02-26 07:06:15.608023+00	{}	{"telemetryNotificationShown": true}
\.
...
COPY public.poll_votes (id, option_id, user_id, created_at, updated_at, poll_id) FROM stdin;
4	0	5e4b6c55c052ed74e32866bb	2022-02-26 07:26:16.885763	2022-02-26 07:26:16.885763	\N
\.
...
COPY public.polls (id, title, description, user_id, channel_token, options, expiry, created_at, updated_at) FROM stdin;
27	Favourite IDE ever	So what IDE do you spend most of you day in?	5e4b6c55c052ed74e32866bb	b6242b05-0300-4b20-954a-d26cc02756d3	[{"id": 0, "text": "Atom"}, {"id": 2, "text": "Visual Code"}]	2020-05-01 00:00:00	2022-02-26 07:26:16.890116	2022-02-26 07:26:16.890116
40	beer	what is your fav beer?	5e4b6c55c052ed74e32866bb	b6242b05-0300-4b20-954a-d26cc02756d3	[{"id": 0, "text": "ales"}, {"id": 1, "text": "lagers"}, {"id": 2, "text": "both"}]	2020-05-09 00:00:00	2022-02-26 07:26:16.890116	2022-02-26 07:26:16.890116
\.
